        ...
        <div>
          ...
          <el-table
            ...
            <el-table-column
              ...
              width="100"
              >
              <template slot-scope="scope">{{ scope.row.sex | sexData}}</template>
            </el-table-column>
            <el-table-column
              prop="phone"
              width="200"
      ...
      <div style="text-align: left">
        <el-dialog
          ...
          <el-row>
            <el-col :span="6">
              <div>
                <el-form-item label="账户负责人:" prop="nationId">
                  <el-select v-model="emp.nationId" style="width: 150px" size="mini" placeholder="请选择账户负责人">
                    <el-option
          ...
          <el-row>
            ...
            <el-col :span="5">
              <div>
                <el-form-item label="支付类型:" prop="tiptopDegree">
                  <el-select v-model="emp.tiptopDegree" style="width: 120px" size="mini" placeholder="支付类型">
                    <el-option
          ...
          <el-row>
            <el-col :span="6">
              <div>
                <el-form-item label="账户余额:" prop="beginDate" >
                 <el-input v-model="accountBalanceEdit" placeholder="请输入账户余额" size="mini"  type="number"></el-input>
                </el-form-item>
              </div>
            </el-col>
          ...
          <el-row>
            <el-col :span="8">
              <div>
                <el-form-item label="备注:" prop="idCard">
  ...
  export default {
    data() {
      return {
        ...
        rules: {
          ...
          accountType: [{required: true, message: '必填:账户类型', trigger: 'change'}],
    ...
    methods: {
      ...
      loadEmps(){
        var _this = this;
        this.tableLoading = true;
        this.getRequest("/employee/basic/empList?page=" + this.currentPage + "&size=10&keywords=" + this.keywords + "&politicId=" + this.emp.politicId + "&nationId=" + this.emp.nationId + "&accountType=" + this.emp.accountType + "&jobLevelId=" + this.emp.jobLevelId + "&engageForm=" + this.emp.engageForm + "&departmentId=" + this.emp.departmentId + "&beginDateScope=" + this.beginDateScope).then(resp=> {
...
//            _this.emptyEmpData();
      ...
      //   this.emp.accountType = row.position.id;
